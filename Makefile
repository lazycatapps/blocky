...
.PHONY: download-hosts
download-hosts: ## Download StevenBlack hosts file to content/config/hosts
	@echo "Downloading StevenBlack hosts file..."
	@mkdir -p content/config
	@curl -fsSL https://raw.githubusercontent.com/StevenBlack/hosts/master/hosts -o content/config/hosts
	@echo "Downloaded successfully to content/config/hosts"
	@wc -l content/config/hosts
